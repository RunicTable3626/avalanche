...
- **Polish:** Offline indicator, incoming message banner while app is in foreground, persistent message history across app restarts, basic error handling for network failures.
