...
- Project deep links: `avalanche://project/<server>/<project-id>/<path>` scheme registered on iOS and Android; links open the correct Project view or navigate into a chat
...
- Deep link test: tapping an `avalanche://` link from outside the app opens the correct view on both platforms
